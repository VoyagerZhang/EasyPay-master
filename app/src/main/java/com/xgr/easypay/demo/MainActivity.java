...
public class MainActivity extends AppCompatActivity {
    ...
    private void unionpay(){
        ...
        unionPayInfoImpli.setTn("667378384470215486100");
    ...
    private void wxpay(){
        //实例化微信支付策略
        String wxAppId = "";  //这个是应用APPid
        WXPay wxPay = WXPay.getInstance(this,wxAppId);
        //构造微信订单实体。一般都是由服务端直接返回。
        WXPayInfoImpli wxPayInfoImpli = new WXPayInfoImpli();  //把需要上传给微信的东西放到这个类里
    ...
    private void alipay(){
        ...
        alipayInfoImpli.setOrderInfo(""); //设置orderInfo，由服务端返回的
